...
const CATEGORIES = [
  { value: "Rotina", emoji: "🌅", color: "bg-orange-100 text-orange-800" },
  { value: "Organização", emoji: "📦", color: "bg-blue-100 text-blue-800" },
  { value: "Sono", emoji: "😴", color: "bg-indigo-100 text-indigo-800" },
  { value: "Alimentação", emoji: "🥗", color: "bg-green-100 text-green-800" },
  { value: "Bem-estar", emoji: "🧘", color: "bg-purple-100 text-purple-800" },
  { value: "Educação", emoji: "📚", color: "bg-yellow-100 text-yellow-800" },
  { value: "Relacionamento", emoji: "💕", color: "bg-pink-100 text-pink-800" },
  { value: "Finanças", emoji: "💰", color: "bg-emerald-100 text-emerald-800" },
  { value: "Autocuidado", emoji: "✨", color: "bg-rose-100 text-rose-800" },
];
