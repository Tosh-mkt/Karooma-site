        ...
        <section className="py-16 bg-white relative">
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              ...
              <p className="font-inter text-sm text-gray-500 text-center italic">Como associado da Amazon, a Karooma ganha com compras qualificadas que auxiliam na manutenção da estrutura para continuidade e melhoria do serviço.</p>
